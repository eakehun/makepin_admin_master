				...
				<tr>
					...
					<td colspan="3">
						<b-form-group v-slot="{ ariaDescribedby }" class="radio_box">
							<b-form-radio v-model="detailData.fixed" :aria-describedby="ariaDescribedby" name="some-radios" value="true">고정</b-form-radio>
							<b-form-radio v-model="detailData.fixed" :aria-describedby="ariaDescribedby" name="some-radios" value="false">일반</b-form-radio>
						</b-form-group>
					</td>
				</tr>
				<tr>
	...
	export default{
		...
		methods: {
			...
			uploadData(){
				...
				axios
				.put(process.env.VUE_APP_BASE_URL+'/admin/board/notice/', this.detailData, { withCredentials: true })
